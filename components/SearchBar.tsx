    ...
    <form onSubmit={handleSubmit} className="w-full max-w-4xl mx-auto mb-8">
      <div className="relative">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="absolute top-1/2 left-3 transform -translate-y-1/2 p-2 bg-gradient-to-br from-teal-500 to-cyan-600 text-white rounded-full shadow-lg hover:shadow-cyan-500/50 hover:scale-110 active:rotate-90 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100 disabled:rotate-0"
        >
          {isLoading ? (
